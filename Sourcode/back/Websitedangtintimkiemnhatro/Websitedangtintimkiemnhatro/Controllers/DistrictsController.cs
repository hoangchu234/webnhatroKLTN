...
namespace Websitedangtintimkiemnhatro.Controllers
{
    ...
    public class DistrictsController : ControllerBase
    {
        ...
        // GET: api/Districts/5
        [HttpGet]
        [Route("GetDistrictByProvince/{id}")]
        public async Task<ActionResult<IEnumerable<District>>> GetDistrictByProvince(int id)
        {
            var dictrict = await _context.Districts.Where(a => a.ProvinceId == id).ToListAsync();
        ...
        public async Task<ActionResult<District>> GetDistrictByID(int id)
        {
